### 慕课网 通过 ceph-ansible快速部署  Ceph16（pacific）版本基于 Centos8 系统
...
172.31.96.71 ceph02  1Cpu 2G内存  20G系统盘，20G数据盘
172.31.96.72 ceph03  1Cpu 2G内存  20G系统盘，20G数据盘
```cassandraql
cat >> /etc/hosts <<EOF
172.31.96.70 ceph01 
172.31.96.71 ceph02 
...
安装日志如下为成功
```cassandraql
[root@ceph01 ~]# cephadm bootstrap --mon-ip 172.31.96.71
...
[root@ceph01 ~]# ceph orch ls
NAME                       PORTS        RUNNING  REFRESHED  AGE  PLACEMENT  
alertmanager               ?:9093,9094      1/1  2m ago     54m  count:1    
crash                                       3/3  2m ago     54m  *          
grafana                    ?:3000           1/1  2m ago     54m  count:1    
mds.cephfs                                  3/3  2m ago     6m   count:3    
mgr                                         2/2  2m ago     54m  count:2    
mon                                         3/5  2m ago     54m  count:5    
nfs.nfs                                     3/3  2m ago     2m   count:3    
node-exporter              ?:9100           3/3  2m ago     54m  *          
osd.all-available-devices                     3  2m ago     23m  *          
prometheus                 ?:9095           1/1  2m ago     54m  count:1    
rgw.rgw                    ?:80             3/3  2m ago     14m  count:3    
```
